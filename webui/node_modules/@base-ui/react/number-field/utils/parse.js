...
const ARABIC_DETECT_RE = exports.ARABIC_DETECT_RE = new RegExp(`[${ARABIC_NUMERALS.join('')}]`);
const PERSIAN_DETECT_RE = exports.PERSIAN_DETECT_RE = new RegExp(`[${PERSIAN_NUMERALS.join('')}]`);
const HAN_DETECT_RE = exports.HAN_DETECT_RE = new RegExp(`[${HAN_NUMERALS.join('')}]`);
