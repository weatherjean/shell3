...
// still in flight. Send returns it as an immediate Error event; SwitchAgent,
// SetParam, and RegisterHostTool return it (or surface it) directly. Drain the in-flight Send channel to completion, then retry.
