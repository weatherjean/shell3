...
func TestParseRejectsInvalidConfig(t *testing.T) {
	tests := []struct {
		...
		{name: "removed main instructions", src: `(shell3 (version 1) (model m (api-key-env KEY) (id "x")) (orchestrator (model m) (instructions "old")))`, want: `unknown orchestrator field "instructions"`},
		{name: "removed provider selector", src: `(shell3 (version 1) (model m (provider openai-compatible) (api-key-env KEY) (id "x")))`, want: `unknown model field "provider"`},
		{name: "removed runner stdin", src: `(shell3 (version 1) (runner r (command "run") (stdin prompt-file) (result stdout)))`, want: `unknown runner field "stdin"`},
		{name: "removed runner stdout", src: `(shell3 (version 1) (runner r (command "run") (stdout text) (result stdout)))`, want: `unknown runner field "stdout"`},
		{name: "removed agent instructions", src: `(shell3 (version 1) (runner r (command "run") (result stdout)) (agent a (using r) (instructions "task")))`, want: `unknown parameter "instructions"`},
