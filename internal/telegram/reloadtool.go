...
// user (handleMsg) or wake (runWakeTurn) turn can start mid-swap; Reload itself
// also fail-fasts if a session is busy. Shared by /reload and the reload tool's
// end-of-turn apply. Any input queued while the slot was held is drained after.
