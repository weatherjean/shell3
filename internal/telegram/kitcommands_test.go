...
func TestKitCommand_Answers(t *testing.T) {
	...
	b.handleCommand(context.Background(), Msg{ChatID: 42, SenderID: 42, Text: "/standup week"})
...
func TestKitCommand_FailureReported(t *testing.T) {
	...
	b.handleCommand(context.Background(), Msg{ChatID: 42, SenderID: 42, Text: "/broken"})
...
func TestKitCommand_EmptyOutputPostsNothing(t *testing.T) {
	...
	b.handleCommand(context.Background(), Msg{ChatID: 42, SenderID: 42, Text: "/hush"})
...
func TestKitCommand_UnknownStillUnknown(t *testing.T) {
	...
	b.handleCommand(context.Background(), Msg{ChatID: 42, SenderID: 42, Text: "/nope"})
